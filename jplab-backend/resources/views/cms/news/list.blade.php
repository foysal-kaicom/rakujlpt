            ...
            <table class="min-w-full border border-gray-300 text-sm stripe">
                ...
                <tbody>
                    ...
                    <tr class="border">
                        ...
                        <td class="px-4 py-3 flex" class="">
                            @hasPermission('news.edit')
                            <a href="{{ route('news.edit', $news->id) }}" class="px-3 py-2 rounded-lg text-xs font-medium bg-sky-500 text-white hover:bg-sky-600 shadow-md transition">
                                Edit
                            </a>
                            @endHasPermission
                            @hasPermission('news.delete')
                            <a href="{{ route('news.delete', $news->id) }}" class="px-3 py-2 rounded-lg text-xs font-medium bg-red-400 text-white hover:bg-red-500 shadow-md transition ml-2"
                    ...
                    @empty
                    <tr>
                        <td colspan="8" class="text-center p-3">No news found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
