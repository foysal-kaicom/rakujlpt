...
<div class="card shadow-lg border-0 rounded-3">
    ...
    <!-- Form -->
    <form action="{{ route('review.store') }}" method="POST" enctype="multipart/form-data" class="p-4">
        @csrf
        ...
        <div class="row g-4">
            ...
            <div class="col-md-3 text-center">
                <div class="position-relative border rounded bg-light d-flex align-items-center justify-content-center shadow-sm h-[250px]">
                    <img id="imagePreview" src="{{ asset('imagePH.png') }}" alt="Reviewer Image"
            ...
            <div class="col-md-9">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="reviewer_designation" value="{{ old('reviewer_designation') }}"
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="body" rows="5" class="form-control shadow-sm rounded-2" placeholder="Write the review here...">{{ old('body') }}</textarea>
