...
export default function ExamDetailsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-5">
      <div className="relative w-full max-w-xl rounded-3xl bg-gradient-to-br from-purple-100/90 via-violet-100/90 to-pink-100/90 shadow-2xl border border-violet-300">
        {/* Top Glow */}
        ...
        <div className="w-full max-h-[80vh] overflow-y-auto scrollbar-thin p-7">
          {/* Header */}
