...
import { FaPaperPlane, FaStar, FaArrowRight } from "react-icons/fa";
...
export default function MocktestResultModal({
  ...
  return (
    <>
      {!showAnsEval && !isOpen && (
        <div className="min-h-screen bg-linear-to-br from-purple-50 to-indigo-100 flex items-center justify-center p-4">
          <div className="relative max-w-2xl">
            <div className="bg-white rounded-xl shadow-2xl p-8 text-center  w-full max-h-[90vh] overflow-y-auto">
              ...
              >
                <RiBarChartBoxAiFill /> Show Answer
              </button>
      ...
      {isOpen && (
        <div className="min-h-screen bg-linear-to-br from-purple-50/80 to-indigo-100/80 flex items-center justify-center p-4">
